...
// Importez votre widget Home()
import 'home.dart'; // Remplacez par le chemin correct vers votre fichier home.dart
...
class _DashboardState extends State<Dashboard> {
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              ...
              // Redirection vers Home() après la déconnexion
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildActivityItem('Documents',
                  'RuxLsr a ajouter un document 20240619', '23 juin a 07:16', 'RL'),
  ...
  Widget _buildActivityItem(String title, String description, String date,
      String initials) {
    return Padding(
      padding:
